...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[880px] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-card border border-muted bg-background p-6 shadow-lg duration-200",
        className
      )}
      {...props}
    >
